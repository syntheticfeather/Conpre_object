...
|字段名|类型|是否必填|说明|示例值|
|---|---|---|---|---|
|idCard|string|是|身份证号码，需要符合标准身份证号格式|110101199003072316|
|realName|string|是|真实姓名|张三丰|
...
|---|---|---|---|---|---|
| bankCardId         |   Text  |   银行卡号               |    是    | 必须填写符合标准的银行卡号格式   | 4111111111111111、5500000000000004、6225880123456788001、3530111333300000、5425233430109903 |
